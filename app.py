...
st.set_page_config(page_title="MDT 多学科会诊 AI Agent (乳腺专科)", page_icon="🎀", layout="wide")

st.title("🎀 MDT 多学科会诊 AI Agent (乳腺专科)")
...
## 影像与病理检查
- **超声**：右乳外上象限可见一低回声结节，大小约 2.5 x 2.0 cm，边界不清，形态不规则，内见点状强回声。右侧腋窝可见肿大淋巴结，皮质增厚。BI-RADS 5类。
- **钼靶**：右乳外上象限高密度影，伴簇状细小钙化。
- **穿刺活检（右乳及腋窝）**：
  - 右乳组织：浸润性导管癌，II级。
  - 右腋窝穿刺：见癌细胞。
