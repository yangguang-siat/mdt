...
def main():
    ...
    if not os.getenv("OPENAI_API_KEY") or "your_api_key" in os.getenv("OPENAI_API_KEY"):
        print("⚠️ 警告: 未配置有效的 OPENAI_API_KEY。请在 .env 文件中填入 API Key 后重试。")
        return
